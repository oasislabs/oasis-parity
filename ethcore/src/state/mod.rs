...
impl<B: Backend> State<B> {
	...
	pub fn apply(&mut self, env_info: &EnvInfo, machine: &Machine, t: &SignedTransaction, tracing: bool, storage: &Storage) -> ApplyResult<FlatTrace, VMTrace> {
		if tracing {
	...
	fn execute<T, V>(&mut self, env_info: &EnvInfo, machine: &Machine, t: &SignedTransaction, options: TransactOptions<T, V>, virt: bool, storage: &Storage)

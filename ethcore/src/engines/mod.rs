...
use parity_machine::{LocalizedMachine as Localized, Machine, TotalScoredHeader};
...
pub fn total_difficulty_fork_choice<T: TotalScoredHeader>(new: &T, best: &T) -> ForkChoice
where

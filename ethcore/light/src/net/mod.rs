...
mod timeout {
	...
	pub const HANDSHAKE: Duration =  Duration::from_millis(6_000);
	pub const ACKNOWLEDGE_UPDATE: Duration = Duration::from_millis(1_000);
	pub const BASE: u64 = 3500; // base timeout for packet.

// TODO: если сессия прерывается после того как CommonData пришла, то получается что в следующий KeyShare уже будетЮ но без версий - к чему это приведёт???
// TODO: тест - обновленная версия сохранилась на N1+N2, а на новом (N3) - не сохранилась. Начинаем новую сессию => ничего не работает (это лучше проверять в SSChange)
